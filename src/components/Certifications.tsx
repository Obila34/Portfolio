...
const certifications = [
  ...
  },
  {
    ...
    date: "2026",
    link: "https://www.credly.com/badges/dc6965e5-d655-42bb-a23f-672b8fd3a40f/public_url",
    badgeColor: "from-purple-600 to-indigo-500"
  }
];
                  ...
                  <CardContent className="p-8 flex items-center gap-6">
                    ...
                    <div className="flex-grow">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-xs font-mono uppercase tracking-widest flex items-center gap-1 hover:text-accent transition-colors">
